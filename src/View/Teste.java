...
public class Teste {
	...
	private void initialize() {
		...
		lblDificilSelected.setIcon(new ImageIcon(Teste.class.getResource("/view/img/circleJogadores.png")));
		...
		lblMedioSelected.setIcon(new ImageIcon(Teste.class.getResource("/view/img/circleJogadores.png")));
		...
		lblFacilSelected.setIcon(new ImageIcon(Teste.class.getResource("/view/img/circleJogadores.png")));
		...
		lbl3PlayersSelected.setIcon(new ImageIcon(Teste.class.getResource("/view/img/circleJogadores.png")));
		...
		lbl2PlayersSelected.setIcon(new ImageIcon(Teste.class.getResource("/view/img/circleJogadores.png")));
		...
		lblFundoCampeonatoCad.setIcon(new ImageIcon(Teste.class.getResource("/view/img/fundoCampeonatoCad.png")));
		...
		lblVermelhoOn.setIcon(new ImageIcon(Teste.class.getResource("/view/img/vermelho-on.png")));
		lblVermelhoOn.setBounds(465, 463, 216, 216);
		panelJogo.add(lblVermelhoOn);
		
		 lblAzulOn = new JLabel("New label");
		lblAzulOn.setIcon(new ImageIcon(Teste.class.getResource("/view/img/azul-on.png")));
		lblAzulOn.setBounds(246, 464, 216, 216);
		panelJogo.add(lblAzulOn);
		
		 lblVerdeOn = new JLabel("New label");
		lblVerdeOn.setIcon(new ImageIcon(Teste.class.getResource("/view/img/verde-on.png")));
		lblVerdeOn.setBounds(466, 248, 216, 216);
		panelJogo.add(lblVerdeOn);
		
		lblAmareloOn = new JLabel("New label");
		lblAmareloOn.setIcon(new ImageIcon(Teste.class.getResource("/view/img/amarelo-on.png")));
		...
		lblFundoCadJogadores.setIcon(new ImageIcon(Teste.class.getResource("/view/img/pagina3Jogadores.png")));
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(grupoJogadores.getSelection() != null && grupoDificuldade.getSelection()!=null && !txtNomeCampeonato.getText().isBlank()) {
					...
					if(radio2Jogadores.isSelected()) {
						lblFundoCadJogadores.setIcon(new ImageIcon(Teste.class.getResource("/view/img/pagina2Jogadores.png")));
		...
		lblFundo.setIcon(new ImageIcon(Teste.class.getResource("/view/img/playFundo.png")));
